                        ...
                        <div class="detailed-box">
                            <div class="col-xs-12 col-sm-5 col-md-3">
                                <div class="post-thumbnail">
                                    <img style="width: 350px; height: 400px;" src="books/'.$coverImg.'" alt="Book Image">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-7 col-md-6"  >
                                <div class="post-center-content" style="width: 500px; height: 400px; margin-left: 1%">
                                    ...
                                    <p><strong>Edition:</strong> '.$edition.' edition</p>                           
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-3 ">
                                <div class="post-right-content" >
                                    <h4>'.$messege.'</h4>
                                    <p><strong>Total Copies:</strong> '.$stock.'</p>
                                    <p><strong>Accession:</strong> '.$accession.'</p>                                                      
                                   
                                     <label style="display: none" id="accession" name="accession">'.$accession.'</label>

                                </div>
                                <div style="margin-top: 20%">
                               
                                  <a href="" id="btnPlaceHold" class="btn btn-dark-gray" style="width: 200px">Place a Hold</a> 
