            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                        <?php
                        $rows =(new dbhelper)->__getPendingOrders();
                        if($rows != 0 )
                        {
                            $i=1;
                            foreach ($rows as $row){
                    ...
                    <tr>
                        ...
                        <td>'.$course.'</td>
                         <td>'.$regno.'</td>
                        <td><input href="#" data-toggle="modal" data-target="#aprove" onclick="confirmOrder(id);" type="submit" id="'.$oid.'" class="btn btn btn-primary" value="Aprove"> &nbsp;&nbsp;&nbsp;<input type="button" id="'.$oid.'" onclick="setRejectId(id)" data-toggle="modal" data-target="#reject"  class="btn btn-warning" value="Reject"></td>
                    </tr>';
                                $i++;
                            }
                        }
